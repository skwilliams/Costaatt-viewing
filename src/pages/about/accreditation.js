      ...
      <div className={GridStyles.row}>
        <div className={GridStyles.col1of2}>
          <p className={AboutStyles.section_accreditation__text_box1}>
            ...
            legal and regulatory frameworks, we strive to identify, redress and
            continually improve our quality systems and processes. As such,
            COSTAATT embraces the national and international quality standards
            and requirements set by the{" "}
            <a href="https://www.actt.org.tt/" target="_blank">
              Accreditation Council of Trinidad and Tobago
            </a>
            (ACTT), which was established by Act of Parliament, No. 16 of 2004,
            to accredit registered post-secondary and tertiary education
      ...
      <div className={GridStyles.row}>
        ...
        <div className={GridStyles.col1of2}>
          <p className={AboutStyles.section_accreditation__text_box}>
            ...
            its operations and programme offerings, and in addition welcomes the
            objective analysis of its quality processes through external
            evaluation.
          </p>
          <p className={AboutStyles.section_accreditation__text_box}>
            COSTAATT is indeed proud to be the first institution in Trinidad and
            Tobago to have received ACTT accredited institution status for the
            period November 18, 2010 to November 17, 2017 (the maximum period of
            seven years). In 2017, the College received reaffirmation of its
            institutional accreditation status again for the maximum seven-year
            period. The College therefore holds accredited institution status
...
accreditation.getLayout = function getLayout(page) {
