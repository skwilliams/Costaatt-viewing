    ...
    <>
      <div className={admissionStyles.adminHome}>
        <section className={admissionStyles.topHeader}>
          <TopHeader image={home5} color="royalblue" text="How To Apply" />
        </section>
        ...
        <section className={admissionStyles.applicationInstructions}>
          ...
          <Accordion>
            ...
            <AccordionDetails>
              <p>
                A student who has not completed any college-level courses and
                who wishes to enrol in a degree programme at COSTAATT. To
                download your paper application or apply online (only applicable
                to New, Transfer, CARICOM and International applicants)
              </p>
            </AccordionDetails>
          </Accordion>
          <Accordion>
            ...
            <AccordionDetails>
              <p>
                ...
                recognised higher education institution and who wishes to enrol
                in a degree programme at COSTAATT. The College evaluates the
                transcripts of transfer students to determine equivalency with
                its own programmes and requirements for graduation. Please note
                that, depending on the programme of study, there is a limit to
                the number of credits that may be transferred or the number of
                exemptions that may be granted. Transfer applicants must be in
                good academic standing at the previous institution. Please
                contact the Admissions Office for further information.
                Applicants wishing to transfer to COSTAATT with advanced
                standing* must submit the following: *Advanced standing
                acknowledges prior study through the award of credit Official
                transcripts of all subjects previously completed at a tertiary
                level institution Copies of syllabus/course outlines for courses
                completed A completed Request for Transfer Credit form, which is
                available at the Admissions Office Download your paper
                application or apply online (only applicable to New, Transfer,
          ...
          <div>
            ...
            <p>
              CARICOM and international applicants must submit official copies
              of transcripts of all subjects completed at prior secondary and
              tertiary institutions. If these documents are not in English, a
              certified translation is required. It may also be necessary to
              have the qualifications assessed by the Accreditation Council of
              Trinidad & Tobago (ACTT) or the Curriculum Planning and
              Development Division (CPDD), Ministry of Education located at the
              Rudranath Capildeo Learning Resource Centre. Qualifications
              supplied will be assessed to determine equivalence to programme
              entry requirements. Applicants whose first language is not English
              must provide evidence of proficiency in English via an
              internationally recognized English Language test, such as the
              TOEFL (Test of English as a Foreign Language) or IELTS
              (International English Language Testing System). To obtain
              information on TOEFL please visit the ETS (Education Testing
              Service) website at www.ets.org or email toefl@ets.org. For
              ...
              online (only applicable to New, Transfer, CARICOM and
          ...
          <div>
            ...
            <p>
              ...
              decision can be made. Some programmes require:
            </p>
            <p>&nbsp;</p>
            <Accordion>
              <AccordionSummary expandIcon={<ExpandMoreIcon />}>
            ...
            <Accordion>
              ...
              <AccordionDetails>
                ...
                <p>
                  However, you may be exempt from taking tests in English
                  language and mathematics if you already have the requisite
                  level of achievement (see the exemptions below). The results
                  of these tests tell us whether you may need help to strengthen
                  your academic foundations. If you do need help, we will place
                  you in the appropriate level course to help you succeed in
                  your major.
                </p>
                <p>
