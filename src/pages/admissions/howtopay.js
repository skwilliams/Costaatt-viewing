...
const howtopay = () => {
  return (
    <>
          ...
          <div className={AdminStyles.feetwoColGrid}>
            ...
            <div className={AdminStyles.feesreq}>
              <ul className={AdminStyles.feeslist}>
                ...
                <li className={AdminStyles.feesitems}>
                  {" "}
                  Using your credit card or VISA debit card* select the items to
                  be paid for and checkout
                </li>
              </ul>
            </div>{" "}
            {/*end of lisiting */}
          ...
          <div className={AdminStyles.feetwoColGrid}>
            ...
            <div className={AdminStyles.feesreq}>
              <ul className={AdminStyles.feeslist}>
                ...
                <li className={AdminStyles.feesitems}>
                  {" "}
                  Include in your payment description your student ID, then type
                  of fee you are paying and the relevant term/semsester{" "}
                </li>
              </ul>
            </div>{" "}
            {/*end of lisiting */}
      ...
      <section id="directdeposit" className={AdminStyles.sectionDirectdeposit}>
      ...
      <section id="afterpay" className={AdminStyles.sectionAfterpay}>
        ...
        <div className={AdminStyles.feetwoColCon}>
          <div className={AdminStyles.feetwoColGrid}>
            <Image className={AdminStyles.icon} src={after} alt="after icon" />{" "}
          </div>
          <div className={AdminStyles.feetwoColGrid}>
            <div className={AdminStyles.text}> </div>
            <div className={AdminStyles.feesreq}>
              <ul className={AdminStyles.feeslist}>
                ...
                <li className={AdminStyles.feesitems}>
                  ...
                  <span>
                    ...
                    <Link href="#" className={AdminStyles.emphasis}>
                      {" "}
                      Place location of Chagauans Campus
                    </Link>{" "}
                  </span>
                </li>
                <li className={AdminStyles.feesitems}>
                ...
                <li className={AdminStyles.feesitems}>
                  ...
                  <span>
                    ...
                    <Link href="#" className={AdminStyles.emphasis}>
                      {" "}
                      Place location of South Campus
                    </Link>{" "}
                  </span>
                </li>
                <li className={AdminStyles.feesitems}>
                  ...
                  <span>
                    ...
                    <Link href="#" className={AdminStyles.emphasis}>
                      {" "}
                      Place location of Tobago Campus
                    </Link>{" "}
                  </span>{" "}
                </li>
              </ul>
