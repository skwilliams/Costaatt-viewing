  ...
  return (
    <>
      ...
      <section>
        ...
        <p className={standardStyles.paragraph}>
          {" "}
          To create your account, simply create a Login ID and PIN. Your Log In
          ID must consist of up to nine (9) characters and numbers while your
          PIN (personal identification number) must be six (6) numbers in
          length. Re-enter your PIN for confirmation. Important: Please choose a
          Login ID and PIN that you can easily remember should you need to
        ...
        <p className={standardStyles.paragraph}>
          Step 3: Terms, Conditions and Declaration Carefully read and agree to
          the terms and conditions which appear at the end of the application.
        </p>
        <p className={standardStyles.paragraph}>
          Step 4: Submit Application Confirmation Page and Supporting Documents
          Save the confirmation page as a PDF or JPEG document and submit it
          along with PDF or JPEG supporting documents to
