    ...
    <>
      ...
      <SideNavOnlyLayout>
        ...
        >
          ...
          <p className={AdmisStyles.text}>
            {" "}
            <b>Registration</b> for new students opens on <b>28 August,2023</b>
          </p>
          <p className={AdmisStyles.text}>
        ...
        >
          ...
          <div className={AdmisStyles.entryreq}>
            <ol className={AdmisStyles.list}>
              ...
              <li className={AdmisStyles.items}>
                Enter your username found at top left of your acceptance letter
                e.g. 00099999.
              </li>
              <li className={AdmisStyles.items}>
                {" "}
              ...
              <li className={AdmisStyles.items}>
                Follow the prompts to create a new password and security profile
                for yourself.{" "}
              </li>
              <li className={AdmisStyles.items}>
              ...
              >
                {/* {" "} */}
                You can refer to Banner Online Payment Manual to use our mobile
                app
              </Link>{" "}
              {/* </p> */}
            </ol>
        ...
        >
          ...
          <div className={AdmisStyles.entryreq}>
            <ul className={AdmisStyles.list}>
              <li className={AdmisStyles.items}>
                ...
                e-Service registration number. If you do not yet have an e-GATE
                ID, you may contact any{" "}
              ...
              <li className={AdmisStyles.items}>
                ...
                submit an application for GATE funding for this semester via the
                e-GATE web portal.
              </li>
            </ul>
            ...
            <div className={AdmisStyles.threeColGridCon}>
              ...
              <div className={AdmisStyles.threeColGrid}>
                ...
                <p className={AdmisStyles.text}>
                  {" "}
                  <b>HOTLINE</b>{" "}
                  <span className={AdmisStyles.anchortag}>800-GATE (4283)</span>
                </p>
              </div>
              <div className={AdmisStyles.threeColGrid}>
                {" "}
          ...
          <div className={AdmisStyles.entryreq}>
            <ol className={AdmisStyles.list}>
              ...
              <li className={AdmisStyles.items}>
                The student copy of the GATE e-Service application is a required
                document for making a payment on campus.
              </li>
              <li className={AdmisStyles.items}>
          ...
          <p className={AdmisStyles.emphasis}>
            ...
            courses at a cost of $300 per credit. Students can access a payment
            plan to assist with tuition fees.
          </p>
        </section>
        <section
          id="payment"
        ...
        >
          ...
          <div className={AdmisStyles.entryreq}>
            ...
            <ul className={AdmisStyles.list}>
              ...
              <li className={AdmisStyles.items}>
                Online banking via FCB and Republic Bank (COSTAATT is listed as
                a registered payee)
              </li>
            </ul>
            <p>
            ...
            <ol className={AdmisStyles.list}>
              ...
              <li className={AdmisStyles.items}>
                ...
                or submit to the Administrative Office at your campus by October
                28,2023:
          ...
          <div className={AdmisStyles.entryreq}>
            <ul className={AdmisStyles.list}>
              ...
              <li className={AdmisStyles.items}>
                If plan is approved, sign and submit the agreement using either
                method mentioned in #2
              </li>
        ...
        >
          ...
          <p className={AdmisStyles.text}>
            Although we have resumed face-to-face interactions at our campuses,
            please be advised that appointments will be required for the
            following services:{" "}
          </p>
          <div className={AdmisStyles.entryreq}>
            <ul className={AdmisStyles.list}>
