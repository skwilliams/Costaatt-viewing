...
import { PhoneCallback, Sanitizer } from '@mui/icons-material';
...
const studentorg = () => {
  return (
    <>
      ...
      <section id="introtoclubs" className={standardStyles.sectionNoSidenav}>
      ...
      <div className={standardStyles.marginBottomBig}></div>
      <section id="existingclubs" className={standardStyles.sectionclubs}>
        ...
        <div className={standardStyles.row}>
          ...
          <div className={standardStyles.col1of2}>
            <div className={standardStyles.joinclub}>
              ...
              {/* <h3 className={standardStyles.paragraph}> We are so exciting for you to join us </h3> */}
      ...
      <section id="ambassadors" className={standardStyles.sectionNoSidenav}>
        <h2 className={standardStyles.headingPrimarysub}>
          {" "}
          Student Ambassadors
        </h2>
        <div className={standardStyles.row}>
          ...
          <div className={standardStyles.col1of2}>
            <div className={standardStyles.compositon}>
              <>
                <Image
                  ...
                  width="200"
                  height="0"
                  className={standardStyles.composition}
                  src={startclub}
                />
